...
type ImageStorage interface {
	CreateImage(ctx context.Context, img entity.Image, data []byte) error
...
func (s *imageService) CreateImage(ctx context.Context, img entity.Image, data []byte) error {
	return s.storage.CreateImage(ctx, img, data)
}
